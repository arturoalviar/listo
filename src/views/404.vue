<template>
  <div class="listo-not-found h-full flex flex-col items-center">
    <div class="container p-6 h-full flex flex-col items-center lg:flex-row">
      <div class="relative">
        <h1 class="listo-page-heading">{{ pageTitle }}</h1>
        <p class="mt-8 text-lg">
          <router-link to="/">
            <ArrowLeftIcon class="inline-flex w-4 h-4" />
            Go back
            <span class="font-bold"> home</span>
          </router-link>
        </p>
      </div>
      <div class="relatvie w-full max-w-3xl mx-auto">
        <router-link to="/">
          <svg
          ...
          >
            ...
            <g class="cls-2">
              <g>
                ...
                <polygon
                  class="cls-11"
                  points="494 447.23 560.11 636.84 656.45 575.86 581.63 377.54 494 447.23"
                />
                <path
                  class="cls-4"
